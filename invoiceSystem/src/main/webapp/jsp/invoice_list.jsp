...
<div class="page-container">
	...
	<c:set var="row_count" value="0"></c:set>
	 ...
	 <c:set var="row_count" value="${row_count+1}" />
	  ...
	  <span class="l">电子发票库存剩余：<font size="3" color="red">300</font>张
	 </span>
	 <span class="r">共有数据：<strong>2</strong> 条
	 </span>
	  </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tr class="text-c">
					...
					<a style="text-decoration:none" class="ml-5" onClick="invoice_open('',1)" href="javascript:;" title="生成">生成</a>
					<a style="text-decoration:none" class="ml-5" onClick="invoice_down('')" href="javascript:;" title="下载">下载</a>				
